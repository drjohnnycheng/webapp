...
def main():
    ...
    if st.sidebar.button("Proceed"):
        if opt == 1:  # Show module code
            ...
            st.sidebar.header("Invalid Option!")

    st.sidebar.markdown('''<hr>''', unsafe_allow_html=True)
    st.sidebar.markdown('''<small>[Overview](https://github.com/drjohnnycheng/webapp/blob/main/README.md) | [CWordTM](https://github.com/drjohnnycheng/cwordtm) | February 2025</small>''', unsafe_allow_html=True)
